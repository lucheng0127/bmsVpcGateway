...
type NetworkV1alpha1Interface interface {
	...
	VpcConnectionsGetter
}

// NetworkV1alpha1Client is used to interact with features provided by the network.stack.io group.
type NetworkV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetworkV1alpha1Client) VpcConnections() VpcConnectionInterface {
	return newVpcConnections(c)
}
